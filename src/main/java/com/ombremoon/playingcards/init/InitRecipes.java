...
public class InitRecipes {
    ...
    public static final DeferredHolder<RecipeSerializer<?>, RecipeSerializer<CardDeckRecipe>> DECK = RECIPES.register("deck", () -> new SimpleCraftingRecipeSerializer<>(CardDeckRecipe::new));

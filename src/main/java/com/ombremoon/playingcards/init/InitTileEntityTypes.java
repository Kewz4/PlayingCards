...
public class InitTileEntityTypes {
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileEntityPokerTable>> POKER_TABLE = TILE_ENTITY_TYPES.register("poker_table", () -> BlockEntityType.Builder.of(TileEntityPokerTable::new, InitItems.POKER_TABLE.get()).build(null));
